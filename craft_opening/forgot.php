        ...
        <section class="form login form-container">
            ...
            <div class="text-center">
                <div class="button-container">
                    ...
                    <button type="button" onclick="redirectToPage('deliver-personnel')" class="custom-button">Deliver Person</button>
                </div>
            </div>
        </section>
    </div>
...
<script>
        ...
        function redirectToPage(accType) {
            if (accType === 'company-rep') {
                window.location.href = '../craft_opening/craft_company/forgot.php'; // Replace with the actual client page
            } else if (accType === 'seller') {
                window.location.href = '../craft_opening/craft_seller/forgot.php'; // Replace with the actual seller page
            } else if (accType === 'buyer') {
                window.location.href = '../craft_opening/craft_buyer/forgot.php'; // Replace with the actual buyer page
            }
            else if (accType === 'deliver-personnel') {
                window.location.href = '../craft_opening/craft_delivery/forgot.php'; // Replace with the actual buyer page
            }
        }
    </script>
