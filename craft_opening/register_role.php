...
<script>
        ...
        function redirectToPage(accType) {
            if (accType === 'company-rep') {
                window.location.href = '../craft_opening/craft_company/register.php'; // Replace with the actual client page
            } else if (accType === 'seller') {
                window.location.href = '../craft_opening/craft_seller/register.php'; // Replace with the actual seller page
            } else if (accType === 'buyer') {
                window.location.href = '../craft_opening/craft_buyer/register.php'; // Replace with the actual buyer page
            }
            else if (accType === 'deliver-personnel') {
                window.location.href = '../craft_opening/craft_delivery/register.php'; // Replace with the actual buyer page
            }
        }
    </script>
