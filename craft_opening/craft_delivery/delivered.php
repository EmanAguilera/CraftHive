    ...
    <img src="../uploaded_profile/CH-Logo.png" alt="Profile Image">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h1>Delivery's Management</h1>
					<ul class="breadcrumb">
						<li>
							<a href="ch-company.php">Deliver</a>
						</li>
						<li><i class='bx bx-chevron-right' ></i></li>
						<li>
							<a class="active" href="ch-company.php">Management</a>
						</li>
					</ul>
				</div>
			</div>
...
<section class="recent-transactions">
   ...
   <table>
      ...
      <tbody>
         <?php
         // SQL Query to fetch only delivered orders for the logged-in delivery person
         $query = "SELECT o.order_id, o.product_name, o.buyer_name, o.quantity, o.total_price, 
         o.shipping_address, o.proof_receipt, p.image
         FROM `order` o
         JOIN product p ON o.product_id = p.product_unique_id
         WHERE o.delivery_id = '$delivery_id' AND o.status = 'Delivered'";
         ...
         <tr>
            ...
            <td>
   <?php 
    $receipt_path = htmlspecialchars($row['proof_receipt']);
    if (!empty($receipt_path)) { ?>
         <img src="../../uploaded_receipts/<?php echo $receipt_path; ?>" height="100" alt="Proof Receipt">
    <?php } else { ?>
   ...
   <?php } ?>
         ...
         <?php
             ...
             echo "<tr><td colspan='7' class='empty'>No delivered orders found</td></tr>";
         }
         ?>
      </tbody>
   </table>
