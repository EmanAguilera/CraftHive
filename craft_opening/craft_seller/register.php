...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 0) {
        ...
        $query = "SELECT email, phone FROM seller WHERE email = ? OR phone = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            $insert_query = "INSERT INTO seller (unique_id, company_rep_id, fname, lname, phone, email, password, status, commission_rate, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, 'Active', '0.80', now())";
