...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $conn->prepare("SELECT unique_id, password, company_rep_id FROM company WHERE email = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $company['password'])) {
            ...
            $_SESSION['unique_id'] = $company['unique_id'];
            $_SESSION['company_rep_id'] = $company['company_rep_id']; // Store the company_rep_id
